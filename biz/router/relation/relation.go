...
import (
	...
	relation "github.com/obrr-hhx/simpleDouyin/biz/handler/relation"
)
		...
		_douyin := root.Group("/douyin", _douyinMw()...)
		{
			...
			}
			{
				_follow := _relation.Group("/follow", _followMw()...)
				{
					...
					_list.POST("/", append(_relationfollowlistMw(), relation.RelationFollowList)...)
				}
			}
			{
				_follower := _relation.Group("/follower", _followerMw()...)
				{
					...
					_list0.POST("/", append(_relationfollowerlistMw(), relation.RelationFollowerList)...)
				}
			}
			{
				_friend := _relation.Group("/friend", _friendMw()...)
				{
					...
					_list1.POST("/", append(_relationfriendlistMw(), relation.RelationFriendList)...)
				}
			}
		}
	}
