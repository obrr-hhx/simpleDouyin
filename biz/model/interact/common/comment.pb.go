...
import (
	...
	common "github.com/obrr-hhx/simpleDouyin/biz/model/common"
...
type Comment struct {
	...
	CreateDate int64        `protobuf:"varint,4,opt,name=create_date,json=createDate,proto3" json:"create_date,omitempty" form:"create_date" query:"create_date"` // comment publication date, format mm-dd
}
...
type DouyinCommentActionRequest struct {
	...
	ActionType  int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" json:"action_type,omitempty" form:"action_type" query:"action_type"`     // action type: 1 -> Post comment, 2 -> Delete comment
	CommentText string `protobuf:"bytes,4,opt,name=comment_text,json=commentText,proto3" json:"comment_text,omitempty" form:"comment_text" query:"comment_text"` // comment content
	CommentId   int64  `protobuf:"varint,5,opt,name=comment_id,json=commentId,proto3" json:"comment_id,omitempty" form:"comment_id" query:"comment_id"`          // comment id
}
...
type DouyinCommentActionResponse struct {
	...
	StatusCode int32    `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" query:"status_code" form:"status_code" json:"status_code"`     // error code
	...
	Comment    *Comment `protobuf:"bytes,3,opt,name=comment,proto3" json:"comment,omitempty" form:"comment" query:"comment"`                            // comment
}
...
type DouyinCommentListResponse struct {
	...
	StatusCode  int32      `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" query:"status_code" form:"status_code" json:"status_code"`               // error code
	StatusMsg   string     `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty" form:"status_msg" query:"status_msg"`           // status description
	CommentList []*Comment `protobuf:"bytes,3,rep,name=comment_list,json=commentList,proto3" json:"comment_list,omitempty" form:"comment_list" query:"comment_list"` // comment list
}
...
var file_comment_proto_rawDesc = []byte{
	...
	0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x1a, 0x09, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x1a, 0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x22, 0x6f, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x19, 0x0a, 0x04, 0x75,
	...
	0x65, 0x22, 0xb0, 0x01, 0x0a, 0x1a, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x43, 0x6f, 0x6d, 0x6d,
	...
	0x6e, 0x74, 0x49, 0x64, 0x22, 0xa0, 0x01, 0x0a, 0x1b, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x43,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e,
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x07,
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x4b, 0x0a, 0x18, 0x44, 0x6f, 0x75, 0x79, 0x69,
	...
	0x65, 0x6f, 0x49, 0x64, 0x22, 0xa7, 0x01, 0x0a, 0x19, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x43,
	...
	0x09, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x12, 0x32, 0x0a, 0x0c, 0x63, 0x6f,
	0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x0f, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	0x74, 0x52, 0x0b, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xf4,
	0x01, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65,
	0x72, 0x12, 0x74, 0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x41, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x22, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x44, 0x6f, 0x75, 0x79,
	...
	0x2f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x6c, 0x0a, 0x0b, 0x43, 0x6f, 0x6d, 0x6d, 0x65,
	0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x20, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e,
	...
	0x6e, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x4c,
	0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x18, 0xd2, 0xc1, 0x18,
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x6f, 0x62, 0x72, 0x72, 0x2d, 0x68, 0x68, 0x78, 0x2f, 0x73, 0x69, 0x6d,
	0x70, 0x6c, 0x65, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f,
...
var file_comment_proto_goTypes = []interface{}{
	...
	(*DouyinCommentActionRequest)(nil),  // 1: common.DouyinCommentActionRequest
	(*DouyinCommentActionResponse)(nil), // 2: common.DouyinCommentActionResponse
	(*DouyinCommentListRequest)(nil),    // 3: common.DouyinCommentListRequest
	(*DouyinCommentListResponse)(nil),   // 4: common.DouyinCommentListResponse
	(*common.User)(nil),                 // 5: User
}
var file_comment_proto_depIdxs = []int32{
	5, // 0: common.Comment.user:type_name -> User
	0, // 1: common.DouyinCommentActionResponse.comment:type_name -> common.Comment
	0, // 2: common.DouyinCommentListResponse.comment_list:type_name -> common.Comment
	1, // 3: common.CommentHandler.CommentAction:input_type -> common.DouyinCommentActionRequest
	3, // 4: common.CommentHandler.CommentList:input_type -> common.DouyinCommentListRequest
	2, // 5: common.CommentHandler.CommentAction:output_type -> common.DouyinCommentActionResponse
	4, // 6: common.CommentHandler.CommentList:output_type -> common.DouyinCommentListResponse
